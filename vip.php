...
<div id="slogan">
  ...
  <div class="container features" id="first">
    <center><h3 style="width: 350px"><center>Produits VIP</center></h3></center>
  </div>
  ...
  if($db_found){
      ...
      $sql_count = mysqli_query($db_handle,"SELECT COUNT(*) AS nom FROM objet WHERE type='immediat' AND typeobjet='VIP'") or exit(mysql_error());
      $donnees = mysqli_fetch_array($sql_count);
      $num = $donnees['nom'];
 
     
      
        $sql = "SELECT * FROM objet   WHERE type='immediat' AND typeobjet='VIP'" ;
  ...
  if($db_found){
      ...
      $sql_count = mysqli_query($db_handle,"SELECT COUNT(*) AS nom FROM objet WHERE type='enchere'  AND typeobjet='VIP'") or exit(mysql_error());
      $donnees = mysqli_fetch_array($sql_count);
      $num = $donnees['nom'];
 
     
      
        $sql = "SELECT * FROM objet  WHERE type='enchere' AND typeobjet='VIP'" ;
        $result = mysqli_query($db_handle,$sql);
            for($i=1;$i<=$num;$i++) {
  ...
  if($db_found){
      ...
      $sql_count = mysqli_query($db_handle,"SELECT COUNT(*) AS nom FROM objet WHERE type='meilleuroffre' AND typeobjet='VIP'") or exit(mysql_error());
      $donnees = mysqli_fetch_array($sql_count);
      $num = $donnees['nom'];
 
     
      
        $sql = "SELECT * FROM objet  WHERE type='meilleuroffre' AND typeobjet='VIP'" ;
        $result = mysqli_query($db_handle,$sql);
            for($i=1;$i<=$num;$i++) {
